...
use novissimo3s\view\StatusView;
...
';
    	...
    	echo '<META HTTP-EQUIV="REFRESH" CONTENT="2; URL=index.php?page=status">';
    }
...
';
        ...
        echo '<META HTTP-EQUIV="REFRESH" CONTENT="3; URL=index.php?page=status">';
	}
