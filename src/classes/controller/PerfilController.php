        ...
        if($this->dao->excluir($selecionado)){
            ...
            echo '
                    <div class="alert alert-danger" role="alert">
                        Falha ao tentar excluir   Perfil 
                    </div>

                ';
        }
    	echo '<META HTTP-EQUIV="REFRESH" CONTENT="2; URL=index.php?pagina=perfil">';
    }
...
<div class="alert alert-danger" role="alert">
  Falha ao tentar Inserir Perfil
</div>

';
		}
        echo '<META HTTP-EQUIV="REFRESH" CONTENT="3; URL=index.php?pagina=perfil">';
	}
    ...
    public function restPUT()
    {
        ...
        if (isset($jsonBody['sigla'])) {
            $pesquisado->setSigla($jsonBody['sigla']);
        }
    ...
    public function restPOST()
    {
        ...
        if (! ( isset ( $jsonBody ['nome'] ) && isset ( $jsonBody ['sigla'] ))) {
			echo "Incompleto";
			return;
		}

        $adicionado = new Perfil();
