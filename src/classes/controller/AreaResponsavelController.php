...
class AreaResponsavelController {
    ...
    public function deletar(){
        ...
        $selecionado = new AreaResponsavel();
	    $selecionado->setId($_GET['deletar']);
        if(!isset($_POST['deletar_area_responsavel'])){
...
';
    ...
    public function editar(){
        ...
        if(!isset($_POST['editar_area_responsavel'])){
    ...
    public function restPOST()
    {
        ...
        $adicionado = new AreaResponsavel();
