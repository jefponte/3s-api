        ...
        <div class="card-body">
            <form class="user" method="post" id="edit_form_area_responsavel">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $department->nome }}" name="nome"
                        id="nome" placeholder="Nome">
                </div>
                <div class="form-group">
                    <label for="descricao">Descricao</label>
                    <input type="text" class="form-control" value="{{ $department->descricao }}" name="descricao"
                        id="descricao" placeholder="Descricao">
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="text" class="form-control" value="{{ $department->email }}" name="email"
