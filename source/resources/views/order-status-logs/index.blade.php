...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Orderstatuslogs</div>
                    <div class="card-body">
                        <a href="{{ url('/order-status-logs/create') }}" class="btn btn-success btn-sm" title="Add New OrderStatusLog">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Id</th><th>Order Id</th><th>Status</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
