...
";
    ...
    public function fetchById(Ocorrencia $request)
    {
        $lista = array();
        $id = $request->getId();
    ...
    public function fetchByAreaResponsavel(Ocorrencia $request)
    {
        $lista = array();
        $areaResponsavel = $request->getAreaResponsavel()->getId();
    ...
    public function fetchByServico(Ocorrencia $request)
    {
        $lista = array();
        $servico = $request->getServico()->getId();
    ...
    public function fetchByIdLocal(Ocorrencia $request)
    {
        $lista = array();
    ...
    public function fetchByUsuarioCliente(Ocorrencia $request)
    {
        $lista = array();
        $usuarioCliente = $request->getUsuarioCliente()->getId();
    ...
    public function fetchByDescricao(Ocorrencia $request)
    {
        $lista = array();
