	...
	public function fetch() {
        ...
        try {
		    ...
		    foreach ( $result as $row) 
            {
                ...
                $tarefaOcorrencia->getOcorrencia()->setDataAbertura( $row ['data_abertura_ocorrencia_ocorrencia'] );
                $tarefaOcorrencia->getOcorrencia()->setDataAtendimento( $row ['data_atendimento_ocorrencia_ocorrencia'] );
                $tarefaOcorrencia->getOcorrencia()->setDataFechamento( $row ['data_fechamento_ocorrencia_ocorrencia'] );
                $tarefaOcorrencia->getOcorrencia()->setDataFechamentoConfirmado( $row ['data_fechamento_confirmado_ocorrencia_ocorrencia'] );
