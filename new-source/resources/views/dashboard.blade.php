        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                ...
                btn-warning btn-circle btn-lg"
                                    data-toggle="collapse" href="#collapseAtraso" role="button" aria-expanded="false"
                                    aria-controls="collapseAtraso"><i class="fa fa-expand icone-maior"></i></button>
                            </h3>
                        ...
                        <div class="panel-heading">
                            <h3 class="pb-4 mb-4 font-italic border-bottom" data-toggle="collapse"
                                ...
                                <button type="button"
                                    class="float-right btn ml-3
                btn-warning btn-circle btn-lg"
                                    data-toggle="collapse" href="#collapseAberto" role="button" aria-expanded="false"
                                    aria-controls="collapseAberto"><i class="fa fa-expand icone-maior"></i></button>
                            </h3>
            ...
            <aside class="col-md-4 blog-sidebar">
                <div class="p-4 mb-3 bg-light rounded">
                    ...
                    <form id="form-filtro-basico">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="filtro-minhas-demandas">
                        ...
                        <div class="custom-control custom-switch mb-3">
                            <input type="checkbox" class="custom-control-input" id="filtro-minhas-solicitacoes">
